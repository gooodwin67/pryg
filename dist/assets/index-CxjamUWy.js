const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./main-CM537oH3.js","./three-DOpQIdiv.js"])))=>i.map(i=>d[i]);
let E;
let __tla = (async ()=>{
    (function() {
    ...
    window.__loadMain = ()=>E(()=>import("./main-CM537oH3.js").then(async (m)=>{
                await m.__tla;
                return m;
