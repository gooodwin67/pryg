...
let __tla = (async () => {
  ...
  const ht = "modulepreload", dt = function(r, s) {
    ...
    if (a && a.length > 0) {
      ...
      e = h(a.map((c) => {
        ...
        if (u.rel = d ? "stylesheet" : ht, d || (u.as = "script"), u.crossOrigin = "", u.href = c, l && u.setAttribute("nonce", l), document.head.appendChild(u), d) return new Promise((g, b) => {
  ...
  function ve(r) {
    ...
    if (r == null ? void 0 : r.isObject3D) {
      ...
      return new xs().setFromObject(r);
    }
    const s = (_c = (_b = r.position) != null ? _b : r.pos) != null ? _c : new y(), a = ut((_d = r.size) != null ? _d : 1), i = ((_e2 = r.quaternion) == null ? void 0 : _e2.isQuaternion) ? r.quaternion : ((_f = r.rotation) == null ? void 0 : _f.isEuler) ? ge.setFromEuler(r.rotation) : ge.set(0, 0, 0, 1);
  ...
  function Os(r) {
    ...
    const s = [];
    for (const a of r.children) ((_a2 = a.userData) == null ? void 0 : _a2.persistent) || s.push(a);
    s.forEach((a) => r.remove(a));
  }
  function yt({ scene: r, maxParticles: s = 800, gravity: a = -7.8, drag: i = 2, texture: e = null, pointSize: t = 0.66, blending: o = Te } = {}) {
    ...
    const l = e || n(), h = new Float32Array(s * 3), c = new Float32Array(s * 3), d = new Float32Array(s), p = new Float32Array(s), m = new Float32Array(s), u = new Uint8Array(s), g = new Ss();
    ...
    return {
      trigger(v, M = 1, w = {}) {
        const { count: D = 42, spread: j = 0.35, up: N = 3, horiz: X = 2.2, ttl: _ = [
          0.35,
          0.8
<<<<<<<< HEAD:dist/assets/index-yX05Qziw.js
...
>>>>>>>> 9033cfa0df4abbcd1cb150717768552d863933e0:dist/assets/index-CHAikS9M.js
        }
...
>>>>>>>> 9033cfa0df4abbcd1cb150717768552d863933e0:dist/assets/index-CHAikS9M.js
  ...
  function ft({ scene: r, size: s = 1.5, ttl: a = 0.9 } = {}) {
  ...
  function bt(r, s, a, i) {
    ...
    const n = a.getWorldDirection(new y()).multiplyScalar(2.5), l = a.position.clone().add(n);
    l.z = a.position.z - 1.5, r.position.copy(l), r.updateMatrixWorld(true), ((_c = r.userData) == null ? void 0 : _c.mixer) && r.userData.mixer.update(1 / 60), s.compile(i, a);
    const h = s.getRenderTarget(), c = new je(1, 1, {
      depthBuffer: false,
      stencilBuffer: false
    });
    s.setRenderTarget(c), s.render(i, a), s.setRenderTarget(h), c.dispose(), r.position.copy(e.position), r.quaternion.copy(e.quaternion), t.forEach(({ object3d: d, frustumCulled: p, visible: m, castShadow: u, receiveShadow: g }) => {
  ...
  function vt(r, s, a, i) {
    ...
    s.setRenderTarget(l), s.render(a, i), s.setRenderTarget(e), l.dispose(), r.visible = n, t && (s.shadowMap.autoUpdate = o, s.shadowMap.needsUpdate = true);
  }
  class wt {
    ...
    playerMove() {
      ...
      if ((this.player.userData.body.linvel().x != 0 || this.player.userData.body.linvel().y != 0) && V(this.player, this.levelClass.boostHatMeshes) && !this.levelClass.boostHatModels[this.levelClass.boostHatMeshes.indexOf(V(this.player, this.levelClass.boostHatMeshes))].userData.fly && this.levelClass.boostHatMeshes.indexOf(V(this.player, this.levelClass.boostHatMeshes)) != this.player.userData.canFlyNum && (this.player.userData.canFly || (this.player.userData.canFly = true, this.player.userData.canFlyJumps = this.player.userData.canFlyJumpsMax, this.player.userData.canFlyNum = this.levelClass.boostHatMeshes.indexOf(V(this.player, this.levelClass.boostHatMeshes)), this.levelClass.boostHatModels[this.player.userData.canFlyNum].userData.fly = true, this.audioClass.takeAudio.isPlaying && this.audioClass.stopMusic([
        ...
        const s = this.player.userData.readyJump ? Math.PI / 2 : 0, a = this.player.userData.readyJump ? -Math.PI / 2 : 0, i = this.player.userData.body.linvel().y < -1 ? Math.PI / 1.5 : 0, e = this.player.userData.body.linvel().y < -1 ? -Math.PI / 1.5 : 0, t = this.player.userData.readyJump ? Math.PI / 8 : 0, o = this.player.userData.body.linvel().y < -0.4 ? Math.PI / 7 : 0, n = this.player.userData.body.linvel().y > 0.4 ? Math.PI / -5.9 : 0, l = this.player.userData.readyJump ? 0.75 : 1.18, h = this.player.userData.readyJump ? 0.55 : 0.15;
        this.rightHand.rotation.z = this.lerp(this.rightHand.rotation.z, s, 0.1), this.leftHand.rotation.z = this.lerp(this.leftHand.rotation.z, a, 0.1), this.rightHand.rotation.z = this.lerp(this.rightHand.rotation.z, i, 0.1), this.leftHand.rotation.z = this.lerp(this.leftHand.rotation.z, e, 0.1), this.head.rotation.x = this.lerp(this.head.rotation.x, t, 0.1), this.head.position.y = this.lerp(this.head.position.y, l, 0.1), this.head.position.z = this.lerp(this.head.position.z, h, 0.1), this.head.rotation.z = this.lerp(this.head.rotation.z, o, 0.1), this.head.rotation.z = this.lerp(this.head.rotation.z, n, 0.1);
      ...
      if (this.player.userData.canFlyJumps) {
        ...
        const t = new Bs().setFromEuler(new $(0, Math.PI / 2, 0)), o = e.clone().multiply(t), l = new y(0.01, 0.14, 0.05).clone().applyQuaternion(o);
  ...
  function Vs(r = "ru", s = document) {
    ...
    if (s.querySelectorAll("[data-i18n]").forEach((e) => {
      ...
      we(a, "ui.langToggle") === "ru" || r === "ru" ? (e.classList.remove("us"), e.classList.add("ru"), e.src = "images/ru.svg") : (e.classList.remove("ru"), e.classList.add("us"), e.src = "images/us.svg");
    }
  }
  function xt(r, s) {
    if (s != null) Vs(s);
  ...
  function B(r, s = "") {
    ...
    return (_a2 = r.split(".").reduce((t, o) => t && t[o], i)) != null ? _a2 : s;
  }
  const Mt = /* @__PURE__ */ new Set([
    "\u041C\u043E\u0439 \u0440\u0435\u043A\u043E\u0440\u0434",
    "My record"
  ]), xe = (r) => (r == null ? void 0 : r.isMine) === true || (r == null ? void 0 : r.name) === B("hud.mineRecord", "\u041C\u043E\u0439 \u0440\u0435\u043A\u043E\u0440\u0434") || Mt.has(r == null ? void 0 : r.name);
  class Pt {
    constructor(s, a, i, e, t, o, n, l, h, c, d, p, m, u, g, b) {
      ...
      if (this.levelsMode = s, this.maxHeight = 0, this.birdFlyingMark = 10, document.querySelector(".lev_hud span").textContent = s, await this.loadTexture(), await this.loadBarriers(), this.boostHatModel = this.assetsManager.boostHatModel, this.boostHatPropeller = this.assetsManager.boostHatPropeller, this.boostHatMesh = this.assetsManager.boostHatMesh, this.birdYes && (this.angryBirdModel = this.assetsManager.angryBirdModel, this.scene.add(this.angryBirdModel), bt(this.angryBirdModel, this.renderer, this.camera, this.scene)), document.querySelectorAll(".player_panel")[0].classList.add("hidden_screen"), document.querySelectorAll(".player_panel")[1].classList.add("hidden_screen"), document.querySelectorAll(".player_panel")[2].classList.add("hidden_screen"), this.players.forEach((a, i, e) => {
        ...
        if (this.paramsClass.gameDir == "hor") {
          for (let t = 0; t < this.count; t++) {
            let o = z(this.planeWidth, this.planeWidth - 1), n = a + o / 2 + z(this.fixedDistanceHor.min, this.fixedDistanceHor.max), l = z(-1.2, 1.2) - this.planeHeight / 1.5;
            if (e && (o = e[t]), t == 0 ? (this.objs.planes.data[t].size.x = this.planeWidth, this.objs.planes.data[t].size.y = this.planeHeight, this.objs.planes.data[t].size.z = this.objs.grassPlanes.geometryPlaneGrass.parameters.depth, this.objs.topPlanes.data[t].size.x = this.planeWidth + 0.3, this.objs.topPlanes.data[t].size.y = this.objs.topPlanes.geometryPlaneTop.parameters.height, this.objs.grassPlanes.data[t].size.x = this.planeWidth + 0.3, this.objs.grassPlanes.data[t].size.y = this.objs.topPlanes.geometryPlaneTop.parameters.height, this.objs.grassPlanes.data[t].size.z = this.objs.grassPlanes.geometryPlaneGrass.parameters.depth * 1.2) : t == 1 ? (this.objs.planes.data[t].size.x = o, this.objs.planes.data[t].size.y = this.planeHeight, this.objs.topPlanes.data[t].size.x = o + 0.3, this.objs.topPlanes.data[t].size.y = this.objs.topPlanes.geometryPlaneTop.parameters.height, this.objs.grassPlanes.data[t].size.x = o + 0.3, this.objs.grassPlanes.data[t].size.y = this.objs.grassPlanes.geometryPlaneGrass.parameters.height, this.objs.grassPlanes.data[t].size.z = this.objs.grassPlanes.geometryPlaneGrass.parameters.depth) : t == this.count - 1 ? (e ? this.objs.planes.data[t].size.x = e[e.length - 1] - 0.2 : this.objs.planes.data[t].size.x = 5, this.objs.planes.data[t].size.y = this.planeHeight, e ? this.objs.topPlanes.data[t].size.x = e[e.length - 1] : this.objs.topPlanes.data[t].size.x = 5 + 0.3, this.objs.topPlanes.data[t].size.y = this.objs.topPlanes.geometryPlaneTop.parameters.height, e ? this.objs.grassPlanes.data[t].size.x = e[e.length - 1] : this.objs.grassPlanes.data[t].size.x = 5 + 0.3, this.objs.grassPlanes.data[t].size.y = this.objs.grassPlanes.geometryPlaneGrass.parameters.height, this.objs.grassPlanes.data[t].size.z = this.objs.grassPlanes.geometryPlaneGrass.parameters.depth) : (this.objs.planes.data[t].size.x = o, this.objs.planes.data[t].size.y = this.planeHeight, this.objs.topPlanes.data[t].size.x = o + 0.3, this.objs.topPlanes.data[t].size.y = this.objs.topPlanes.geometryPlaneTop.parameters.height, this.objs.grassPlanes.data[t].size.x = o + 0.3, this.objs.grassPlanes.data[t].size.y = this.objs.grassPlanes.geometryPlaneGrass.parameters.height, this.objs.grassPlanes.data[t].size.z = this.objs.grassPlanes.geometryPlaneGrass.parameters.depth), t == 0 ? (l = 1 - this.planeHeight / 1.5, this.objs.planes.data[t].position.x = 0, this.objs.planes.data[t].position.y = l + this.planeHeight / 6 - 1.5, this.objs.topPlanes.data[t].position.x = 0, this.objs.topPlanes.data[t].position.y = l + this.planeHeight / 1.5 + 0.2 - 1.5, this.objs.grassPlanes.data[t].position.x = 0, this.objs.grassPlanes.data[t].position.y = l + this.planeHeight / 1.5 - 1.5) : t == 1 ? (this.objs.planes.data[t].position.x = n + this.fixedDistanceHor.min / 4, this.objs.planes.data[t].position.y = l + this.planeHeight / 6, this.objs.topPlanes.data[t].position.x = n + this.fixedDistanceHor.min / 4, this.objs.topPlanes.data[t].position.y = l + this.planeHeight / 1.5 + 0.2, this.objs.grassPlanes.data[t].position.x = n + this.fixedDistanceHor.min / 4, this.objs.grassPlanes.data[t].position.y = l + this.planeHeight / 1.5) : (this.objs.planes.data[t].position.x = n + this.fixedDistanceHor.min / 4, this.objs.planes.data[t].position.y = l + this.planeHeight / 6, this.objs.topPlanes.data[t].position.x = n + this.fixedDistanceHor.min / 4, this.objs.topPlanes.data[t].position.y = l + this.planeHeight / 1.5 + 0.2, this.objs.grassPlanes.data[t].position.x = n + this.fixedDistanceHor.min / 4, this.objs.grassPlanes.data[t].position.y = l + this.planeHeight / 1.5), this.objs.lamps.data[t].position.x = this.objs.grassPlanes.data[t].position.x, this.objs.lamps.data[t].position.z = -this.planeDepth / 4, this.objs.lamps.data[t].position.y = this.objs.grassPlanes.data[t].position.y + this.objs.grassPlanes.data[t].size.y / 2 + this.objs.lamps.lampHeight - 0.2, this.objs.plafons.data[t].position.x = this.objs.lamps.data[t].position.x, this.objs.plafons.data[t].position.z = this.objs.lamps.data[t].position.z, this.objs.plafons.data[t].position.y = this.objs.lamps.data[t].position.y + 1, this.objs.bulbs.data[t].position.x = this.objs.lamps.data[t].position.x, this.objs.bulbs.data[t].position.z = this.objs.lamps.data[t].position.z, this.objs.bulbs.data[t].position.y = this.objs.lamps.data[t].position.y + 1, this.lights.length < this.lightsCount) {
    ...
    getHorizontalWorldBounds(s = 0) {
      ...
      if (a.unproject(this.camera), i.unproject(this.camera), e.unproject(this.camera), t.unproject(this.camera), this.camera.isPerspectiveCamera) {
        const o = this.camera.position, n = a.clone().sub(o).normalize(), l = i.clone().sub(o).normalize(), h = e.clone().sub(o).normalize(), c = t.clone().sub(o).normalize(), d = (s - o.z) / n.z, p = (s - o.z) / c.z, m = o.clone().add(n.multiplyScalar(d)), u = o.clone().add(l.multiplyScalar(d)), g = o.clone().add(h.multiplyScalar(p)), b = o.clone().add(c.multiplyScalar(p));
        this.bounds = {
          leftX: m.x,
          rightX: u.x,
          topY: g.y,
    ...
    animateTops() {
      ...
      if (this.paramsClass.gameDir == "hor") {
        ...
        for (let a = 0; a < this.objs.grassPlanes.data.length; a++) {
          ...
          if (e && (t || o)) {
            if (t) {
              const n = e.translation(), l = t.x1 + t.w1 + i.size.x * 0.5, h = t.x2 - t.w2 - i.size.x * 0.5, c = (_a2 = i.userData.speed) != null ? _a2 : 0.05;
              ...
              const n = e.translation(), l = 2, h = 0.5, c = (_b = i.userData.speed) != null ? _b : 0.03;
    ...
    lampsAnimate() {
      ...
      if (this.paramsClass.gameDir == "hor") if (this.lightIntensity, this.worldClass.night && !this.worldClass.thunder) {
        ...
        this.objs.plafons.data.forEach((i, e) => {
          ...
          c.userData._lastBulbFactor !== l && (c.size.set(h.x * l, h.y * l, h.z * l), this.apply(e, this.objs.bulbs.data, this.objs.bulbs.bulb), c.userData._lastBulbFactor = l, s = true);
      ...
      switch (this.gameNum) {
        ...
        case 2: {
          ...
          if (e >= 0 && !this.worldClass.thunder || this.levelsMode) {
            ...
            const c = R.clamp(l * this.cam.lookAheadSeconds, -this.cam.lookAheadMax, this.cam.lookAheadMax), d = o + c;
    ...
    spring(s, a, i, e, t) {
      const o = 2 / e, n = o * t, l = 1 / (1 + n + 0.48 * n * n + 0.235 * n * n * n);
      let h = s - a;
      const c = (i + o * h) * t, d = (i - o * c) * l;
      return {
        newPos: a + (h + c) * l,
        newVel: d
      };
    ...
    smoothDamp(s, a, i, e, t, o) {
      e = Math.max(1e-6, e);
      const l = 2 / e, h = l * o, c = 1 / (1 + h + 0.48 * h * h + 0.235 * h * h * h);
      let d = s - a;
      const p = (t > 0 ? t : 1 / 0) * e;
      d = R.clamp(d, -p, p);
      const m = (i + l * d) * o, u = (i - l * m) * c;
      return {
        newPos: a + (d + m) * c,
        newVel: u
      };
  ...
  class ms {
    ...
    addInstancedStatic(s, a, i, e) {
      ...
      const t = ms._toVec3(e.size), o = ms._toVec3((_a2 = e.position) != null ? _a2 : {
        ...
        y: 0,
        z: 0
      }), n = ((_b = e.quaternion) == null ? void 0 : _b.isQuaternion) ? e.quaternion : new Bs(), l = this.world.createRigidBody(this.RAPIER.RigidBodyDesc.kinematicPositionBased().setTranslation(o.x, o.y, o.z).setRotation({
        x: n.x,
        y: n.y,
        z: n.z,
        w: n.w
  ...
  function $s(r) {
    if (r.isMesh && r.geometry) {
      const a = r.geometry;
      return a.boundingBox || a.computeBoundingBox(), a.boundingBox.getSize(Ys), Ys.multiply(r.scale), Ys.clone();
    }
    return new xs().setFromObject(r).getSize(new y());
  }
  class Ct {
    constructor() {
...
<<<<<<<< HEAD:dist/assets/index-yX05Qziw.js
    createLightningBolt(s, a, i) {
      const e = s + (Math.random() - 0.5) * 6, t = -4 + Math.random() * 3, o = i + (Math.random() - 0.5) * 6, n = e - s, l = t - a, h = o - i, c = Math.hypot(n, l, h) || 1, d = n / c, p = l / c, m = h / c, u = n / c, b = -(h / c), x = 0, f = u, k = Math.abs(p) > 0.9 ? new y(1, 0, 0) : new y(0, 1, 0), I = new y(d, p, m), W = new y().crossVectors(I, k).normalize(), v = new y().crossVectors(I, W).normalize(), M = 2 + Math.random() * 2, w = 1.2, D = Math.random() * Math.PI * 2, j = 3 + Math.random() * 2.5, N = 0.8, X = Math.random() * Math.PI * 2, _ = 28, L = 4, J = [];
      for (let A = 0; A <= _; A++) {
        const H = A / _, E = 1 - H;
        let Z = s + n * H, ds = a + l * H, ls = i + h * H;
...
>>>>>>>> 9033cfa0df4abbcd1cb150717768552d863933e0:dist/assets/index-CHAikS9M.js
  ...
  class _t {
    ...
    loadRecsData() {
      ...
      a[0].innerHTML = "", a[1].innerHTML = "", s.forEach((t, o) => {
        Array.isArray(t) && t.forEach((n, l) => {
          if (!Array.isArray(n) || n.length === 0) return;
          const h = n, c = h[0], d = h[1], p = h[2], m = h[3];
          if (!c || !d || !p) return;
          const u = B("leaderboard.mine", "\u041C\u043E\u0439 \u0440\u0435\u043A\u043E\u0440\u0434"), g = h.findIndex((x) => x && x.name === u) < 3 && h.findIndex((x) => x && x.name === u) !== -1, b = this.playersNum === l + 1 ? "" : "hidden_screen";
  ...
  class Lt {
    ...
    updateMetersFloat(s, a, i = "hor") {
      ...
      if (n === Xs) return;
      const l = Xs, h = performance.now(), c = 50, d = (p) => {
        const m = Math.min(1, (p - h) / c), u = 1 - Math.pow(1 - m, 4), g = Math.round(l + (n - l) * u);
  ...
  class At {
    ...
    async loadLevels(s) {
      ...
      for (let l = 0; l < this.levelsStatus[s].length; l++) {
        const h = this.levelsStatus[s][l], { modifierClass: c, labelText: d, ariaState: p } = e(h), m = l === 9, u = document.createElement("div");
        u.className = "levels_block ".concat(c).concat(m ? " levels_block--super" : ""), u.setAttribute("data-level", String(l + 1)), u.setAttribute("role", "button"), u.setAttribute("tabindex", h === "locked" ? "-1" : "0"), u.setAttribute("aria-label", "\u0423\u0440\u043E\u0432\u0435\u043D\u044C ".concat(l + 1, ", ").concat(p).concat(m ? ", \u0431\u043E\u043D\u0443\u0441\u043D\u044B\u0439 \u0443\u0440\u043E\u0432\u0435\u043D\u044C" : ""));
...
>>>>>>>> 9033cfa0df4abbcd1cb150717768552d863933e0:dist/assets/index-CHAikS9M.js
    ...
    async loadLevelsContest() {
      ...
      for (let o = 0; o < this.allLevels; o++) {
        ...
        h.style.setProperty("--show-delay", "".concat(c, "ms")), l && h.classList.add("level_player".concat(l));
        const d = document.createElement("div");
        d.className = "levels_block_number", d.textContent = String(n);
        const p = document.createElement("div");
        p.className = "levels_block_status", l ? (p.setAttribute("data-i18n", "contest.player".concat(l)), p.textContent = B("contest.player".concat(l))) : p.textContent = "";
        const m = l ? B("contest.player".concat(l)) : "";
    ...
    processDataAfterLoad() {
      const s = (a) => {
        ...
        const i = this.getMineLabel(), e = [
          ...
          name: "",
          rec: 0
        }), t = e.some((h) => h && h.name === i), o = Number((_a2 = a == null ? void 0 : a[0]) == null ? void 0 : _a2.rec) || 0, n = ((_b = a == null ? void 0 : a[3]) == null ? void 0 : _b.name) === i && Number(a[3].rec) || 0, l = Math.max(o, n);
        if (t) return e;
        {
          const h = {
    ...
    async loadLeaderboardsTop3(s) {
      ...
      const a = !!this.yandexPlayer.isAuthorized, i = a && ((_a2 = this.yandexPlayer.player) == null ? void 0 : _a2.getUniqueID) ? this.yandexPlayer.player.getUniqueID() : null, e = async (t) => {
        try {
          ...
          let h = [];
          if (a && l && i) {
            const p = l.rank || 0, m = typeof l.score == "number" ? l.score : 0;
          ...
          if (a && !h.some((m) => m.isMe || (m == null ? void 0 : m.name) === this.getMineLabel()) && l && i) {
    ...
    async submitMyScore(s, a, i) {
      ...
      try {
        ...
        this.mainScore = [
          ...
          var _a2, _b;
          const h = Number((_a2 = l == null ? void 0 : l[0]) == null ? void 0 : _a2.rec) || 0, c = ((_b = l == null ? void 0 : l[3]) == null ? void 0 : _b.name) === o && Number(l[3].rec) || 0;
    ...
    updateLocalTop3(s, a, i) {
      ...
      const h = l.findIndex((d) => d.isMe), c = Math.max(n, Number(t[0].rec) || 0);
      if (h >= 0) l[h].name = e, l[h].isMe = true, l[h].rec = Math.max(l[h].rec, c), l = l.sort((d, p) => p.rec - d.rec).slice(0, 3);
      else {
        const d = ((_c = l[2]) == null ? void 0 : _c.rec) || 0;
        if (c > d) l.push({
          pos: 0,
          name: e,
          rec: c,
          isMe: true
        }), l = l.sort((p, m) => m.rec - p.rec).slice(0, 3);
        else {
          const p = l.filter((b) => !b.isMe).sort((b, x) => x.rec - b.rec), m = p[0] || {
            pos: 1,
            name: "",
            rec: 0
          }, u = p[1] || {
...
>>>>>>>> 9033cfa0df4abbcd1cb150717768552d863933e0:dist/assets/index-CHAikS9M.js
  ...
  function ze() {
    ...
    i = R.clamp(i, e, t), G.fov = R.radToDeg(i), G.aspect = a, G.updateProjectionMatrix(), F.setSize(r, s);
  }
...
<<<<<<<< HEAD:dist/assets/index-yX05Qziw.js
    ...
    for (let a = 0; a < r; a++) C.players.push(new wt(T, fs, S, C, q, G, P, ws));
...
>>>>>>>> 9033cfa0df4abbcd1cb150717768552d863933e0:dist/assets/index-CHAikS9M.js
  ...
  async function Wt(r) {
    await C.createLevel(r), await C.loadPlayers(), await C.loadEnvironments(), C.objs.grassPlanes.data.length > 0 && C.objs.grassPlanes.data.forEach((s, a) => {
...
>>>>>>>> 9033cfa0df4abbcd1cb150717768552d863933e0:dist/assets/index-CHAikS9M.js
        s.playerMove();
      }), Ps.updateLighting(), C.levelAnimate(G), C.cameraMove(G, r);
...
<<<<<<<< HEAD:dist/assets/index-yX05Qziw.js
  ...
  F.setAnimationLoop(() => {
    if (q != null) {
      let r = Bt.getDelta();
      for (r > Me && (r = Me), se += r; se >= As; ) Ot(As), se -= As;
========
  let Qs = 0;
  const As = 1 / 60, Me = 0.1;
  F.setAnimationLoop(() => {
...
>>>>>>>> 9033cfa0df4abbcd1cb150717768552d863933e0:dist/assets/index-CHAikS9M.js
  ...
  if (Y) {
    ...
    Y.addEventListener("touchstart", function(a) {
      !a.touches || a.touches.length === 0 || (r = a.touches[0].clientY, Y.scrollTop);
    }, {
      passive: true
      ...
      const t = a.touches[0].clientY - r, o = Y.scrollTop <= 0, n = Y.scrollTop + Y.clientHeight >= Y.scrollHeight - 1, l = t > 0, h = t < 0;
      (o && l || n && h) && a.preventDefault();
    }, {
      passive: false
    });
  }
