import { B as U, V as p, Q as X, M as xs, a as Y, b as E, c as T, d as B, G as us, C as M, S as Z, E as z, I as L, D as A, e as js, f as cs, O as Q, T as ms, R as G, P as ss, g as Ps, h as Ds, A as ys, i as C, j as vs, k as Ms, l as Cs, m as D, n as Ss, o as zs, H as Ls, p as As, q as _s, r as ts, W as Es, s as Hs, t as ks, u as Bs, v as Rs, w as K, x as Fs, y as Ts, z as Gs, F as Is, J as Us, K as Ws, L as qs, N as Os, U as Js } from "./three-DjXYLer5.js";
(async ()=>{
    (function() {
    ...
    const Ns = "modulepreload", Ks = function(r, s) {
        ...
        if (e && e.length > 0) {
            ...
            i = h(e.map((c)=>{
                ...
                if (b.rel = d ? "stylesheet" : Ns, d || (b.as = "script"), b.crossOrigin = "", b.href = c, l && b.setAttribute("nonce", l), document.head.appendChild(b), d) return new Promise((m, w)=>{
    ...
    const $s = new U(new p(-.5, -.5, -.5), new p(.5, .5, .5)), ns = new xs, rs = new X;
    function ls(r) {
        if (r?.isObject3D) {
    ...
    class Zs {
        ...
        playerMove() {
            if (_(this.player, this.levelClass.objs.sensorPlanes.data)) {
                ...
                e[0] == 0 && this.player.userData.collider.setCollisionGroups(N([
                    1
                ], [
                    1
                ]));
    ...
    class st {
        constructor(s, e, t, i, a, o, n, l){
            this.scene = s, this.audioClass = e, this.physicsClass = t, this.renderer = i, this.camera = a, this.isMobile = o, this.paramsClass = n, this.worldClass = l, this.cameraSpeed = .01, this.boostHatModel, this.boostHatPropeller, this.boostHatMesh, this.boostHatModels = [], this.boostHatMeshes = [], this.boostHatCoords = [], this.planeWidth = 4, this.planeHeight = 10, this.planeDepth = 1, this.minPlaneWidthTic = 2, this.fixedDistanceHor = {
                min: 1,
                max: 4
                ...
                planes: {
                    ...
                    geometryPlane: new E(this.planeWidth, this.planeHeight, this.planeDepth),
                    materialPlane: new T({
                        color: 52224
                    }),
                    plane: null
                ...
                topPlanes: {
                    ...
                    geometryPlaneTop: new E(this.planeWidth, .4, 1.2),
                ...
                grassPlanes: {
                    ...
                    geometryPlaneGrass: new E(this.planeWidth, .5, this.planeDepth + .2),
                ...
                sensorPlanes: {
                    ...
                    geometryPlaneSensor: new E(this.planeWidth, .4, 1.2),
    ...
    `);
            ...
            this.objs.bulbs.geometryBulb.setAttribute("aEmissive", new js(h, 1)), this.objs.bulbs.materialBulb.onBeforeCompile = (d)=>{
                d.vertexShader = `
  ...
  ` + d.fragmentShader.replace("#include <lights_fragment_begin>", `
    ...
    `);
            ...
            switch(await this.loadTexture(), await this.loadBoostsModel(), this.cameraMove(this.camera), this.getHorizontalWorldBounds(), this.gameNum){
                ...
                case 2:
                    ...
                    for(let t = 0; t < this.count; t++){
                        let i = v(this.planeWidth / this.minPlaneWidthTic, this.planeWidth - 1), a = s + i / 2 + v(this.fixedDistanceHor.min, this.fixedDistanceHor.max), o = v(-1.2, 1.2) - this.planeHeight / 1.5;
                        if (t > 20 && (this.fixedDistanceHor.max = 6), this.minPlaneWidthTic += .1, t > this.count - 10 ? (this.objs.planes.data[t].size.x = .1, this.objs.planes.data[t].size.y = this.planeHeight, this.objs.topPlanes.data[t].size.x = .2 + .3, this.objs.topPlanes.data[t].size.y = this.objs.topPlanes.geometryPlaneTop.parameters.height, this.objs.grassPlanes.data[t].size.x = .2 + .3, this.objs.grassPlanes.data[t].size.y = this.objs.grassPlanes.geometryPlaneGrass.parameters.height, this.objs.grassPlanes.data[t].size.z = this.objs.grassPlanes.geometryPlaneGrass.parameters.depth) : t > 0 ? (this.objs.planes.data[t].size.x = i, this.objs.planes.data[t].size.y = this.planeHeight, this.objs.topPlanes.data[t].size.x = i + .3, this.objs.topPlanes.data[t].size.y = this.objs.topPlanes.geometryPlaneTop.parameters.height, this.objs.grassPlanes.data[t].size.x = i + .3, this.objs.grassPlanes.data[t].size.y = this.objs.grassPlanes.geometryPlaneGrass.parameters.height, this.objs.grassPlanes.data[t].size.z = this.objs.grassPlanes.geometryPlaneGrass.parameters.depth) : (this.objs.planes.data[t].size.x = this.planeWidth, this.objs.planes.data[t].size.y = this.planeHeight, this.objs.topPlanes.data[t].size.x = this.planeWidth + .3, this.objs.topPlanes.data[t].size.y = this.objs.topPlanes.geometryPlaneTop.parameters.height, this.objs.grassPlanes.data[t].size.x = this.planeWidth + .3, this.objs.grassPlanes.data[t].size.y = this.objs.topPlanes.geometryPlaneTop.parameters.height, this.objs.grassPlanes.data[t].size.z = this.objs.grassPlanes.geometryPlaneGrass.parameters.depth), t > this.count - 10) this.objs.planes.data[t].position.x = a + this.fixedDistanceHor.min * 2, this.objs.planes.data[t].position.y = o + this.planeHeight / 6, this.objs.topPlanes.data[t].position.x = a + this.fixedDistanceHor.min * 2, this.objs.topPlanes.data[t].position.y = o + this.planeHeight / 1.5 + .2, this.objs.grassPlanes.data[t].position.x = a + this.fixedDistanceHor.min * 2, this.objs.grassPlanes.data[t].position.y = o + this.planeHeight / 1.5;
                        else if (t == 1) this.objs.planes.data[t].position.x = 4, this.objs.planes.data[t].position.y = o + this.planeHeight / 6, this.objs.topPlanes.data[t].position.x = 4, this.objs.topPlanes.data[t].position.y = o + this.planeHeight / 1.5 + .2, this.objs.grassPlanes.data[t].position.x = 4, this.objs.grassPlanes.data[t].position.y = o + this.planeHeight / 1.5;
                        else if (t > 0) {
                            if (this.objs.planes.data[t].position.x = a, this.objs.planes.data[t].position.y = o + this.planeHeight / 6, this.objs.topPlanes.data[t].position.x = a, this.objs.topPlanes.data[t].position.y = o + this.planeHeight / 1.5 + .2, this.objs.grassPlanes.data[t].position.x = a, this.objs.grassPlanes.data[t].position.y = o + this.planeHeight / 1.5, (t + 1) % 7 === 0) {
                                ...
                                n.position.x = a, n.position.y = this.objs.topPlanes.data[t].position.y + 2, n.userData.num = t, this.boostHatModels.push(n), this.boostHatMeshes.push(n.children[0].children[0].children[0]), this.boostHatCoords.push([
                                    n.position.x,
                                    n.position.y
                                ]), this.scene.add(n);
                            }
                ...
                case 4:
                    ...
                    let e = -5;
                    for(let t = 0; t < this.count; t++){
                        let i = v(this.bounds.rightX / this.minPlaneWidthTic, this.bounds.rightX / 5);
                        ...
                        let a = e + v(this.fixedDistanceVert.min, this.fixedDistanceVert.max);
                        if (this.objs.topPlanes.data[t].position.y = a - 1.3, this.objs.grassPlanes.data[t].position.y = a, this.objs.sensorPlanes.data[t].position.y = a - .3, this.objs.topPlanes.data[t].size.y = .3, this.objs.grassPlanes.data[t].size.y = .7, this.objs.sensorPlanes.data[t].size.y = .9, t > this.count - 10 && (this.objs.topPlanes.data[t].size.x = i / 8 + .1, this.objs.grassPlanes.data[t].size.x = i / 8 + .1, this.objs.sensorPlanes.data[t].size.x = i / 8 + .4), t > 0 ? (this.objs.topPlanes.data[t].size.x = i + .3, this.objs.grassPlanes.data[t].size.x = i + .3, this.objs.sensorPlanes.data[t].size.x = i + .7) : (this.objs.topPlanes.data[t].size.x = 10, this.objs.grassPlanes.data[t].size.x = 10, this.objs.sensorPlanes.data[t].size.x = 10), t > this.count - 10 ? this.objs.grassPlanes.data[t].userData.speed = v(10, 14) / 100 : this.objs.grassPlanes.data[t].userData.speed = v(6, 10) / 100, this.objs.lamps.data[t].position.x = this.objs.grassPlanes.data[t].position.x, this.objs.lamps.data[t].position.z = -this.planeDepth / 8, this.objs.lamps.data[t].position.y = this.objs.grassPlanes.data[t].position.y + this.objs.grassPlanes.data[t].size.y / 2 + this.objs.lamps.lampHeight - .2, this.objs.plafons.data[t].position.x = this.objs.lamps.data[t].position.x, this.objs.plafons.data[t].position.z = this.objs.lamps.data[t].position.z, this.objs.plafons.data[t].position.y = this.objs.lamps.data[t].position.y + 1, this.objs.bulbs.data[t].position.x = this.objs.lamps.data[t].position.x, this.objs.bulbs.data[t].position.z = this.objs.lamps.data[t].position.z, this.objs.bulbs.data[t].position.y = this.objs.lamps.data[t].position.y + 1, (t + 1) % 7 === 0) {
                            let o = this.boostHatModel.clone();
                            o.position.x = v(this.bounds.leftX + 1, this.bounds.rightX - 1), o.position.y = this.objs.topPlanes.data[t].position.y + .5, this.boostHatModels.push(o), this.boostHatMeshes.push(o.children[0].children[0].children[0]), this.boostHatCoords.push([
                                o.position.x,
                                o.position.y
                            ]), this.scene.add(o);
                        }
        ...
        getHorizontalWorldBounds(s = 0) {
            ...
            if (e.unproject(this.camera), t.unproject(this.camera), i.unproject(this.camera), a.unproject(this.camera), this.camera.isPerspectiveCamera) {
                const o = this.camera.position, n = e.clone().sub(o).normalize(), l = t.clone().sub(o).normalize(), h = i.clone().sub(o).normalize(), c = a.clone().sub(o).normalize(), d = (s - o.z) / n.z, u = (s - o.z) / c.z, x = o.clone().add(n.multiplyScalar(d)), b = o.clone().add(l.multiplyScalar(d)), m = o.clone().add(h.multiplyScalar(u)), w = o.clone().add(c.multiplyScalar(u));
                this.bounds = {
                    leftX: x.x,
                    rightX: b.x,
                    topY: m.y,
            ...
            if (this.paramsClass.gameDir == "hor") if (this.lightIntensity, this.worldClass.night) {
                ...
                this.objs.plafons.data.forEach((a, o)=>{
                    ...
                    if (a.pointLight) {
                        ...
                        S.userData._lastBulbFactor !== m && (S.size.set(w.x * m, w.y * m, w.z * m), this.apply(l, this.objs.bulbs.data, this.objs.bulbs.bulb), S.userData._lastBulbFactor = m, s = !0), !n && h.intensity <= .01 && this._emissive[l] <= .02 && (this.lights.push(h), a.pointLight = null, a.glow && (this.glowPool.push(a.glow), this.scene.remove(a.glow), a.glow = null));
                    }
                ...
                this.objs.plafons.data.forEach((i, a)=>{
                    ...
                    o && (o.intensity = C.lerp(o.intensity, 0, .2), o.intensity <= .01 && (o.intensity = 0, this.lights.push(o), i.pointLight = null, i.userData.light = !1, i.glow && (this.scene.remove(i.glow), this.glowPool.push(i.glow), i.glow = null))), this.objs.plafons.plafon.setColorAt(a, this._dayColor), t = !0, this._emissive && this._emissive.length > a && (this._emissive[a] = 0);
                ...
                this.objs.plafons.data.forEach((i, a)=>{
                    const o = i.pointLight;
                    !i.pointLight && this._emissive[a] === 0 || (o && (o.intensity = C.lerp(o.intensity, 0, .2), o.intensity <= .01 && (o.intensity = 0, this.lights.push(o), i.pointLight = null, i.userData.light = !1, i.glow && (this.scene.remove(i.glow), this.glowPool.push(i.glow), i.glow = null))), this.objs.plafons.plafon.setColorAt(a, this._dayColor), t = !0, this._emissive && this._emissive.length > a && (this._emissive[a] = 0));
        ...
        menuInGame = ()=>{
            document.querySelector(".popup_game_btn1").addEventListener("click", ()=>{
                this.hideScreen("popup_in_game"), this.boostHatModels.forEach((s, e, t)=>{
                    s.userData.fly = !1;
                }), this.players[0].playerAliving(!1);
            }), document.querySelector(".popup_game_btn2").addEventListener("click", ()=>{
                this.players.forEach((s, e, t)=>{
                    s.playerAliving(!0);
                }), this.camera.position.z = 7, this.camera.position.y = 2, this.camera.position.x = 0, this.cameraSpeed = .01, this.boostHatModels.forEach((s, e, t)=>{
    ...
    class H {
        ...
        addInstancedDynamic(s, e, t) {
            const i = H._toVec3(t.size), a = H._toVec3(t.position ?? {
                x: 0,
                y: 0,
                z: 0
        ...
        addInstancedStatic(s, e, t, i) {
            const a = H._toVec3(i.size), o = H._toVec3(i.position ?? {
                x: 0,
                y: 0,
                z: 0
        ...
        updateInstancedTransforms() {
            ...
            for (const t of this.instancedBodies){
                const i = H._ensureInvBase(t.mesh), a = t.body.translation(), o = t.body.rotation();
    ...
    class tt {
        ...
        async loadAudio() {
            ...
            await e.loadAsync("audio/back1.mp3").then((t)=>{
                this.backAudio = new D(s), this.backAudio.setBuffer(t), this.backAudio.setLoop(!0), this.backAudio.setRefDistance(100), this.backAudio.setVolume(2), this.musics.push({
                    name: "back",
                    music: this.backAudio
                });
            }).catch((t)=>{
                console.error("Ошибка при загрузке аудио:", t);
            }), await e.loadAsync("audio/ocean.wav").then((t)=>{
                this.oceanAudio = new D(s), this.oceanAudio.setBuffer(t), this.oceanAudio.setLoop(!0), this.oceanAudio.setRefDistance(100), this.oceanAudio.setVolume(.4), this.musics.push({
                    name: "ocean",
                    music: this.oceanAudio
                });
            }).catch((t)=>{
                console.error("Ошибка при загрузке аудио:", t);
            }), await e.loadAsync("audio/inwater.wav").then((t)=>{
                this.inwaterAudio = new D(s), this.inwaterAudio.setBuffer(t), this.inwaterAudio.setLoop(!1), this.inwaterAudio.setRefDistance(200), this.inwaterAudio.setVolume(1), this.musics.push({
                    name: "inwater",
                ...
                this.readyJumpAudio = new D(s), this.readyJumpAudio.setBuffer(t), this.readyJumpAudio.setLoop(!1), this.readyJumpAudio.setRefDistance(400), this.readyJumpAudio.setVolume(30), this.readyJumpAudio.setPlaybackRate(2);
            }).catch((t)=>{
                console.error("Ошибка при загрузке аудио:", t);
            }), await e.loadAsync("audio/quack1.mp3").then((t)=>{
                this.jumpAudio = new D(s), this.jumpAudio.setBuffer(t), this.jumpAudio.setLoop(!1), this.jumpAudio.setRefDistance(400), this.jumpAudio.setVolume(.3), this.quacks.push(this.jumpAudio);
            }).catch((t)=>{
                console.error("Ошибка при загрузке аудио:", t);
            }), await e.loadAsync("audio/quack2.mp3").then((t)=>{
                this.jumpAudio2 = new D(s), this.jumpAudio2.setBuffer(t), this.jumpAudio2.setLoop(!1), this.jumpAudio2.setRefDistance(400), this.jumpAudio2.setVolume(.3), this.quacks.push(this.jumpAudio2);
            }).catch((t)=>{
                console.error("Ошибка при загрузке аудио:", t);
            }), await e.loadAsync("audio/quack3.mp3").then((t)=>{
                this.jumpAudio3 = new D(s), this.jumpAudio3.setBuffer(t), this.jumpAudio3.setLoop(!1), this.jumpAudio3.setRefDistance(400), this.jumpAudio3.setVolume(.3), this.quacks.push(this.jumpAudio3);
            }).catch((t)=>{
                console.error("Ошибка при загрузке аудио:", t);
            }), await e.loadAsync("audio/quack5.mp3").then((t)=>{
                this.jumpAudio4 = new D(s), this.jumpAudio4.setBuffer(t), this.jumpAudio4.setLoop(!1), this.jumpAudio4.setRefDistance(400), this.jumpAudio4.setVolume(.3), this.quacks.push(this.jumpAudio4);
            }).catch((t)=>{
                console.error("Ошибка при загрузке аудио:", t);
            });
        }
    ...
    class at {
        constructor(s, e, t, i, a){
            this.scene = s, this.camera = e, this.renderer = t, this.paramsClass = i, this.isMobile = a, this.ambientLight = new zs(11184810, 1), this.hemiLight = new Ls(16777215, 16777215, 2), this.hemiLight.groundColor.setHSL(.095, 1, .75), this.hemiLight.position.set(0, 10, 0), this.dirLight = new As(16777215, 2), this.dirLight.position.set(0, 5, 5), this.dirLight.castShadow = !0, this.dirLight.shadow.camera.far = 100, this.topLight = 1e3, this.targetObject = new Q, this.dirLight.target = this.targetObject, this.helper = new _s(this.dirLight, 3), this.water, this.night = !1, this._prevCamX = this.camera.position.x;
        }
        async loadWaterSky() {
            ...
            s.turbidity.value = 1, s.rayleigh.value = 3, s.mieCoefficient.value = 5e-4, s.mieDirectionalG.value = .8, this.parameters = {
                ...
                azimuth: 170,
                top: !1
            }, this.blackSky = new Y(new ts(1e4, 1e4), new ks({
                color: 526362,
                side: Bs,
                transparent: !0,
                opacity: 0
...
`;
        ...
        updateSky() {
            ...
            const t = C.degToRad(90 - this.parameters.elevation), i = C.degToRad(this.parameters.azimuth);
    ...
    let ps = 0;
    console.clear();
    let $, bs = !1, q = 0, ds = 1 / 60, lt = new cs, fs, O, W, P, f, k, I, j, R;
    const F = new Gs;
    F.background = new M(13230580);
    const y = new Is(25, window.innerWidth / window.innerHeight, .1, 2e3);
    y.position.z = 7;
    y.position.y = 2;
    const J = Xs();
    let gs = new Us;
    document.body.appendChild(gs.dom);
    const g = new Ws;
    g.setSize(window.innerWidth, window.innerHeight);
    document.body.appendChild(g.domElement);
    g.shadowMap.enabled = !0;
    g.shadowMap.type = qs;
    g.outputColorSpace = Os;
    g.toneMapping = Js;
    g.toneMappingExposure = 1.05;
    ws();
    window.addEventListener("resize", ws, !1);
    function ws() {
        J ? (y.aspect = document.body.offsetWidth / document.body.offsetHeight, y.updateProjectionMatrix(), g.setSize(innerWidth, innerHeight)) : (y.aspect = document.body.offsetWidth / document.body.offsetHeight, y.updateProjectionMatrix(), g.setSize(document.body.offsetWidth, document.body.offsetHeight));
    }
    async function ht(r) {
        ...
        $ = new s.World(new s.Vector3(0, -9.81, 0)), fs = new s.EventQueue(!0), P = new H($, s), R = new nt(y), k = new tt, W = new at(F, y, g, j, J), f = new st(F, k, P, g, y, J, j, W);
        for(let e = 0; e < r; e++)f.players.push(new Zs(F, k, f, j, y));
        I = new et(f, J, g, y, j), I.addKeyListeners();
    }
    async function pt() {
        await W.loadWorld(), await k.loadAudio(), k.backAudio.play(), k.oceanAudio.play();
    }
    async function dt() {
        await f.createLevel(), await f.loadEnvironments(), await f.loadPlayers(), f.objs.grassPlanes.data.length > 0 && f.objs.grassPlanes.data.forEach((r, s)=>{
            f.objs.grassPlanes.data[s].userData.collide.setCollisionGroups(N([
                0
            ], [
                1
            ]));
        }), f.players.length > 0 && f.players.forEach((r, s)=>{
            f.players[s].player.userData.collider.setCollisionGroups(N([
                1
            ], [
                0,
                1
    ...
    async function ut(r, s) {
        ct(), O.toggleLoader(!0), j = new ot, await ht(r), f.gameNum = s, await pt(), await dt(), setTimeout(()=>{
            O.showScreen("hud"), O.toggleLoader(!1), j.dataLoaded = !0, j.gameStarting = !0, bs = !0;
        }, 300);
    }
    O = new it(ut);
    function ct() {
        y.position.z = 7, y.position.y = 2, y.position.x = 0, g.toneMappingExposure = 1.05, I?.removedKeyListeners(), W = null, P = null, f = null, k = null, I = null, j = null, R = null;
    }
    function mt() {
        if (j.dataLoaded) {
            j.gameDir == "hor" ? R.updateMetersFloat(y.position.x - R.startX) : R.updateMetersFloat(y.position.y - R.startY), f.players.forEach((r, s, e)=>{
                r.playerMove();
            }), W.updateLighting(), f.levelAnimate(y), f.cameraMove(y), gs.update();
            ...
            P.updateInstancedTransforms(), $.step(fs), g.render(F, y);
        }
    }
    g.setAnimationLoop(()=>{
        q += lt.getDelta(), q > ds && bs && (mt(), g.render(F, y), q = q % ds);
    });
})();
