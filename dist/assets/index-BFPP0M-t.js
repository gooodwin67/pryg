import { B as R, V as d, Q as Z, M as xs, a as O, b as M, c as F, d as E, G as ss, C, S as is, E as S, I as L, D as k, e as Ps, f as ts, O as as, T as bs, R as G, g as gs, P as N, A as Ds, h as vs, i as Ms, j as fs, k as z, l as Cs, m as zs, n as As, o as x, p as Ss, q as Ls, H as ks, r as Bs, s as _s, t as os, W as Hs, u as Es, v as Ts, w as Rs, x as K, y as Fs, z as Gs, F as Is, J as Us, K as Ws, L as Ns, N as qs, U as Vs, X as Os } from "./three-C-epTDnC.js";
(async ()=>{
    (function() {
    ...
    function us(l) {
        ...
        const s = l.position ?? l.pos ?? new d, a = Qs(l.size ?? 1), i = l.quaternion?.isQuaternion ? l.quaternion : l.rotation?.isEuler ? ps.setFromEuler(l.rotation) : ps.set(0, 0, 0, 1);
        return ds.compose(s, i, a), $s.clone().applyMatrix4(ds);
    }
    function B(l, s) {
        const a = us(l), i = hs(l);
        for(let e = s.length - 1; e >= 0; e--){
            ...
            if (us(t).intersectsBox(a)) return t;
        }
        return null;
    }
    function Zs(l) {
    ...
    class st {
        ...
        playerMove() {
            ...
            if ((this.player.userData.body.linvel().x != 0 || this.player.userData.body.linvel().y != 0) && B(this.player, this.levelClass.boostHatMeshes) && !this.levelClass.boostHatModels[this.levelClass.boostHatMeshes.indexOf(B(this.player, this.levelClass.boostHatMeshes))].userData.fly && this.levelClass.boostHatMeshes.indexOf(B(this.player, this.levelClass.boostHatMeshes)) != this.player.userData.canFlyNum && (this.player.userData.canFly || (this.player.userData.canFly = !0, this.player.userData.canFlyJumps = this.player.userData.canFlyJumpsMax, this.player.userData.canFlyNum = this.levelClass.boostHatMeshes.indexOf(B(this.player, this.levelClass.boostHatMeshes)), this.levelClass.boostHatModels[this.player.userData.canFlyNum].userData.fly = !0, this.audioClass.takeAudio.isPlaying && this.audioClass.stopMusic([
                ...
                "back"
            ]), this.levelClass.showPopupInGame(!1), this.paramsClass.allDie = !0, this.paramsClass.gameStarting = !1)), this.player.userData.lives > 0 && (this.levelClass.boostHatModels.forEach((s, a, i)=>{
                s.userData.fly = !1;
                ...
                y: 0,
                z: 0
            }, !0), this.player.userData.body.setTranslation(new d(this.player.userData.deadPos.x + (.1 + Math.random() * .2), this.player.userData.deadPos.y + .3, this.player.userData.deadPos.z)), this.player.userData.deadPos = new d(0, 0, 0), this.player.userData.live = !0, this.player.userData.playerAlive = !1)), this.reLiveField();
            else {
                const s = this.player.userData.readyJump ? Math.PI / 2 : 0, a = this.player.userData.readyJump ? -Math.PI / 2 : 0, i = this.player.userData.body.linvel().y < -1 ? Math.PI / 1.5 : 0, e = this.player.userData.body.linvel().y < -1 ? -Math.PI / 1.5 : 0, t = this.player.userData.readyJump ? Math.PI / 8 : 0, o = this.player.userData.body.linvel().y < -.4 ? Math.PI / 7 : 0, n = this.player.userData.body.linvel().y > .4 ? Math.PI / -5.9 : 0, r = this.player.userData.readyJump ? .75 : 1.18, h = this.player.userData.readyJump ? .55 : .15;
                this.rightHand.rotation.z = this.lerp(this.rightHand.rotation.z, s, .1), this.leftHand.rotation.z = this.lerp(this.leftHand.rotation.z, a, .1), this.rightHand.rotation.z = this.lerp(this.rightHand.rotation.z, i, .1), this.leftHand.rotation.z = this.lerp(this.leftHand.rotation.z, e, .1), this.head.rotation.x = this.lerp(this.head.rotation.x, t, .1), this.head.position.y = this.lerp(this.head.position.y, r, .1), this.head.position.z = this.lerp(this.head.position.z, h, .1), this.head.rotation.z = this.lerp(this.head.rotation.z, o, .1), this.head.rotation.z = this.lerp(this.head.rotation.z, n, .1);
        ...
        reLiveField() {
            let s = document.querySelectorAll(".player_panel_bottom_lives")[this.levelClass.players.findIndex((a, i, e)=>a.player == this.player)].children;
    ...
    class tt {
        constructor(s, a, i, e, t, o, n, r){
            this.scene = s, this.audioClass = a, this.physicsClass = i, this.renderer = e, this.camera = t, this.isMobile = o, this.paramsClass = n, this.worldClass = r, this.cameraSpeed = .01, this.levelsMode = !1, this.levelsNoFric = !1, this.randomNoFric = 0, this.randomAnimateHor = .2, this.randomAnimateVert = .2, this.canShowAds = !0, this.boostHatModel, this.boostHatPropeller, this.boostHatMesh, this.boostHatModels = [], this.boostHatMeshes = [], this.boostHatCoords = [], this.angryBird, this.birdFlyingMark = 10, this.distanceToBird = 20, this.angryBirdModel, this.maxHeight = 0, this.birdYes = !0, this.planeWidth = 4, this.planeHeight = 10, this.planeDepth = 1, this.minPlaneWidthTic = 1, this.fixedDistanceHor = {
                min: 1,
                max: 4
  ...
  ` + p.fragmentShader.replace("#include <lights_fragment_begin>", `
    ...
    `);
        ...
        apply(s, a, i) {
            ...
            if (!e) {
                ...
                const h = new d;
                r.boundingBox.getSize(h), e = i.userData.invBaseSize = new d(1 / (h.x || 1), 1 / (h.y || 1), 1 / (h.z || 1));
            }
            this._dummy ||= new as;
            const t = this._dummy, o = a[s] || {}, n = this.toVec3(o.size);
            t.position.copy(o.position || new d), o.rotation ? t.rotation.copy(o.rotation) : t.rotation.set(0, 0, 0), t.scale.set(n.x * e.x, n.y * e.y, n.z * e.z), t.updateMatrix(), i.setMatrixAt(s, t.matrix);
        }
        async loadTexture() {
            const s = new bs;
            s.load("textures/plane.jpg", (a)=>{
                ...
                a.wrapS = G, a.wrapT = G, a.repeat.set(this.planeWidth / 4, this.planeHeight / 4), this.objs.planes.plane.material = i;
            }, void 0, function(a) {
                ...
                a.wrapS = G, a.wrapT = G, a.repeat.set(this.planeWidth / 1, this.planeHeight / 8), this.objs.grassPlanes.planeGrass.material = i;
            }, void 0, function(a) {
                console.error("An error happened.");
            });
        }
        async loadBarriers() {
            let s = new M(.5, .7, 1), a = new gs({
                color: 52224,
                transparent: !0,
                opacity: 0
            });
            this.angryBird = new O(s, a), this.angryBird.userData.name = "bird", this.angryBird.userData.speed = f(10, 13) / 100, this.angryBird.userData.flying = !1, this.angryBird.position.y = -5, this.physicsClass.addPhysicsToObject(this.angryBird);
        }
        async createLevel(s, a) {
            if (this.levelsMode = s, this.maxHeight = 0, this.birdFlyingMark = 10, this.birdYes = a, await this.loadTexture(), await this.loadBarriers(), await this.loadBoostsModel(), await this.loadBirdModel(), this.cameraMove(this.camera), this.getHorizontalWorldBounds(), document.querySelectorAll(".player_panel")[0].classList.add("hidden_screen"), document.querySelectorAll(".player_panel")[1].classList.add("hidden_screen"), document.querySelectorAll(".player_panel")[2].classList.add("hidden_screen"), this.players.forEach((i, e, t)=>{
                ...
                if (this.paramsClass.gameDir == "hor") {
                    for(let e = 0; e < this.count; e++){
                        let t = f(this.planeWidth, this.planeWidth - 1), o = i + t / 2 + f(this.fixedDistanceHor.min, this.fixedDistanceHor.max), n = f(-1.2, 1.2) - this.planeHeight / 1.5;
                        ...
                        this.apply(e, this.objs.planes.data, this.objs.planes.plane), this.apply(e, this.objs.topPlanes.data, this.objs.topPlanes.planeTop), this.apply(e, this.objs.grassPlanes.data, this.objs.grassPlanes.planeGrass), this.apply(e, this.objs.lamps.data, this.objs.lamps.lamp), this.apply(e, this.objs.plafons.data, this.objs.plafons.plafon), this.apply(e, this.objs.bulbs.data, this.objs.bulbs.bulb), i = o + t / 2;
                    }
                ...
                case 2:
                    ...
                    let i = -2.5;
                    for(let t = 0; t < this.count; t++){
                        let o = f(this.planeWidth / this.minPlaneWidthTic, this.planeWidth - 1), n = i + o / 2 + f(this.fixedDistanceHor.min, this.fixedDistanceHor.max), r = f(-1.2, 1.2) - this.planeHeight / 1.5;
                        ...
                        this.apply(t, this.objs.planes.data, this.objs.planes.plane), this.apply(t, this.objs.topPlanes.data, this.objs.topPlanes.planeTop), this.apply(t, this.objs.grassPlanes.data, this.objs.grassPlanes.planeGrass), this.apply(t, this.objs.lamps.data, this.objs.lamps.lamp), this.apply(t, this.objs.plafons.data, this.objs.plafons.plafon), this.apply(t, this.objs.bulbs.data, this.objs.bulbs.bulb), i = n + o / 2;
                    }
                ...
                case 4:
                    ...
                    for(let t = 0; t < this.count; t++){
                        ...
                        this.minPlaneWidthTic += .1, Math.random() < .5 ? this.objs.grassPlanes.data[t].userData.direction = 1 : this.objs.grassPlanes.data[t].userData.direction = -1;
                        let n = e + f(this.fixedDistanceVert.min, this.fixedDistanceVert.max);
                        if (this.objs.topPlanes.data[t].position.y = n - 1.3, this.objs.grassPlanes.data[t].position.y = n, this.objs.sensorPlanes.data[t].position.y = n - .3, this.objs.topPlanes.data[t].size.y = .3, this.objs.grassPlanes.data[t].size.y = .7, this.objs.sensorPlanes.data[t].size.y = .9, t > this.count - 10 && (this.objs.topPlanes.data[t].size.x = o / 8 + .1, this.objs.grassPlanes.data[t].size.x = o / 8 + .1, this.objs.sensorPlanes.data[t].size.x = o / 8 + .4), t > 0 ? (this.objs.topPlanes.data[t].size.x = o + .3, this.objs.grassPlanes.data[t].size.x = o + .3, this.objs.sensorPlanes.data[t].size.x = o + .7) : (this.objs.topPlanes.data[t].size.x = 10, this.objs.grassPlanes.data[t].size.x = 10, this.objs.sensorPlanes.data[t].size.x = 10), t > this.count - 10 ? this.objs.grassPlanes.data[t].userData.speed = f(10, 14) / 100 : this.objs.grassPlanes.data[t].userData.speed = f(6, 10) / 100, this.objs.lamps.data[t].position.x = this.objs.grassPlanes.data[t].position.x, this.objs.lamps.data[t].position.z = -this.planeDepth / 8, this.objs.lamps.data[t].position.y = this.objs.grassPlanes.data[t].position.y + this.objs.grassPlanes.data[t].size.y / 2 + this.objs.lamps.lampHeight - .2, this.objs.plafons.data[t].position.x = this.objs.lamps.data[t].position.x, this.objs.plafons.data[t].position.z = this.objs.lamps.data[t].position.z, this.objs.plafons.data[t].position.y = this.objs.lamps.data[t].position.y + 1, this.objs.bulbs.data[t].position.x = this.objs.lamps.data[t].position.x, this.objs.bulbs.data[t].position.z = this.objs.lamps.data[t].position.z, this.objs.bulbs.data[t].position.y = this.objs.lamps.data[t].position.y + 1, (t + 1) % 7 === 0) {
                            let r = this.boostHatModel.clone();
                            r.position.x = f(this.bounds.leftX + 1, this.bounds.rightX - 1), r.position.y = this.objs.topPlanes.data[t].position.y + .5, this.boostHatModels.push(r), this.boostHatMeshes.push(r.children[0].children[0].children[0]), this.boostHatCoords.push([
                                r.position.x,
                                r.position.y
                            ]), this.scene.add(r);
                        }
        ...
        getHorizontalWorldBounds(s = 0) {
            const a = new d(-1, 0, .5), i = new d(1, 0, .5), e = new d(0, 1, .5), t = new d(0, -1, .5);
            if (a.unproject(this.camera), i.unproject(this.camera), e.unproject(this.camera), t.unproject(this.camera), this.camera.isPerspectiveCamera) {
                const o = this.camera.position, n = a.clone().sub(o).normalize(), r = i.clone().sub(o).normalize(), h = e.clone().sub(o).normalize(), c = t.clone().sub(o).normalize(), p = (s - o.z) / n.z, u = (s - o.z) / c.z, D = o.clone().add(n.multiplyScalar(p)), b = o.clone().add(r.multiplyScalar(p)), m = o.clone().add(h.multiplyScalar(u)), w = o.clone().add(c.multiplyScalar(u));
                this.bounds = {
                    leftX: D.x,
                    rightX: b.x,
                    topY: m.y,
        ...
        animateTops() {
            if (this.paramsClass.gameDir == "hor") {
                ...
                for(let a = 0; a < this.objs.grassPlanes.data.length; a++){
                    ...
                    if (!(!t && !o || !e)) {
                        if (t) {
                            const n = e.translation(), r = t.x1 + t.w1 + i.size.x * .5, h = t.x2 - t.w2 - i.size.x * .5, c = i.userData.speed ?? .05;
                            n.x >= h && (i.userData.direction = -1), n.x <= r && (i.userData.direction = 1);
                            const p = i.userData.direction * c, u = n.x + p;
                            ...
                            const n = e.translation(), r = 2, h = .5, c = i.userData.speed ?? .03;
                            n.y >= r && (i.userData.direction = -1), n.y <= h && (i.userData.direction = 1);
                            const p = i.userData.direction * c, u = n.y + p;
                            e.setNextKinematicTranslation({
                                x: n.x,
                                y: u,
                                z: n.z
        ...
        async loadBirdModel() {
            await new ss().loadAsync("models/bird/bird.glb").then((i)=>{
                ...
                e.scale.x = 2, e.scale.y = 2, e.scale.z = 2, e.position.y = 0, e.rotation.y = -Math.PI / 3, this.angryBirdModel = e, this.angryBirdModel.userData.mixer = new Ds(this.angryBirdModel), this.angryBirdModel.userData.action = this.angryBirdModel.userData.mixer.clipAction(t[0]), this.angryBirdModel.userData.action.play(), this.angryBirdModel.userData.clock = new ts;
        ...
        levelAnimate() {
            this.animateTops(), this.lampsAnimate(), this.worldClass.night ? (this.paramsClass.gameDir == "hor" ? this.audioClass.dayNight(!1) : this.audioClass.dayNight(!1, "vert"), this.audioClass.dayNight(!1)) : this.audioClass.dayNight(!0), this.camera.position.x > this.objs.topPlanes.data[this.count - 2].position.x && (this.canShowAds = !1), this.boostHatModels.forEach((s, a, i)=>{
                ...
                y: f(this.maxHeight - 1.5, this.maxHeight),
                z: this.angryBird.userData.body.translation().z
            }), this.birdFlyingMark = this.birdFlyingMark + this.distanceToBird, this.angryBird.userData.speed = f(10, 13) / 100, this.angryBird.userData.flying = !0), this.angryBird.userData.flying && (this.angryBird.userData.body.setNextKinematicTranslation({
        ...
        lampsAnimate() {
            ...
            if (this.paramsClass.gameDir == "hor") if (this.lightIntensity, this.worldClass.night) {
                ...
                const i = this.camera.position.x - this.bounds.rightX / 2, e = this.camera.position.x + this.bounds.rightX * .8;
                this.objs.plafons.data.forEach((t, o)=>{
                    t.pointLight;
                    const n = t.position.x >= i && t.position.x <= e, r = o;
                ...
                this.lampsAnimate.did = !1;
                const i = this.camera.position.y - this.bounds.topY / 2, e = this.camera.position.y + this.bounds.topY * .2;
                this.objs.plafons.data.forEach((t, o)=>{
                    t.pointLight;
                    const n = t.position.y >= i && t.position.y <= e, r = o;
                    if (n && !t.pointLight && this.lights.length > 0) {
                        const h = this.lights.shift();
                        t.pointLight = h, t.glow = this.glowPool.pop() || this.makeGlowSprite(), this.scene.add(t.glow);
                    }
                ...
                case 2:
                    {
                        ...
                        if (i >= 0) {
                            let e = 0;
                            this.players.length > 1 ? e = this.players[i].player.position.x : e = this.players[i].player.position.x + this.bounds.rightX / 2;
    ...
    class _ {
        ...
        static _ensureInvBase(s) {
            ...
            const e = new d(1 / (i.x || 1), 1 / (i.y || 1), 1 / (i.z || 1));
        ...
        addInstancedDynamic(s, a, i) {
            const e = _._toVec3(i.size), t = _._toVec3(i.position ?? {
                x: 0,
                y: 0,
                z: 0
            }), o = i.quaternion?.isQuaternion ? i.quaternion : new Z, n = this.world.createRigidBody(this.RAPIER.RigidBodyDesc.dynamic().setTranslation(t.x, t.y, t.z).setRotation({
                x: o.x,
                y: o.y,
                z: o.z,
                w: o.w
        ...
        updateInstancedTransforms() {
            ...
            for (const i of this.instancedBodies){
                const e = _._ensureInvBase(i.mesh), t = i.body.translation(), o = i.body.rotation();
    ...
    function Q(l) {
        if (l.isMesh && l.geometry) {
            const a = l.geometry;
            return a.boundingBox || a.computeBoundingBox(), a.boundingBox.getSize(Y), Y.multiply(l.scale), Y.clone();
        }
        return new R().setFromObject(l).getSize(new d);
    }
    class et {
        constructor(){
            this.backAudio, this.backAudio2, this.backAudio3, this.oceanAudio, this.inwaterAudio, this.takeAudio, this.readyJumpAudio, this.jumpAudio, this.jumpAudio2, this.jumpAudio3, this.quacks = [], this.musics = [], this.musicDay = !0, this.musicNight = !1, this.timeToChange = 2;
        }
        async loadAudio() {
            const s = new zs, a = new As;
            await a.loadAsync("audio/back1.mp3").then((i)=>{
                this.backAudio = new x(s), this.backAudio.setBuffer(i), this.backAudio.setLoop(!0), this.backAudio.setRefDistance(100), this.backAudio.setVolume(2), this.musics.push({
                    name: "back1",
                ...
                this.backAudio2 = new x(s), this.backAudio2.setBuffer(i), this.backAudio2.setLoop(!0), this.backAudio2.setRefDistance(100), this.backAudio2.setVolume(2), this.musics.push({
                    name: "back2",
                ...
                this.backAudio3 = new x(s), this.backAudio3.setBuffer(i), this.backAudio3.setLoop(!0), this.backAudio3.setRefDistance(100), this.backAudio3.setVolume(.5), this.musics.push({
                    name: "back3",
                ...
                this.oceanAudio = new x(s), this.oceanAudio.setBuffer(i), this.oceanAudio.setLoop(!0), this.oceanAudio.setRefDistance(100), this.oceanAudio.setVolume(.4), this.musics.push({
                    name: "ocean",
                ...
                this.inwaterAudio = new x(s), this.inwaterAudio.setBuffer(i), this.inwaterAudio.setLoop(!1), this.inwaterAudio.setRefDistance(200), this.inwaterAudio.setVolume(1), this.musics.push({
                    name: "inwater",
                ...
                this.looseAudio = new x(s), this.looseAudio.setBuffer(i), this.looseAudio.setLoop(!1), this.looseAudio.setRefDistance(200), this.looseAudio.setVolume(1), this.musics.push({
                    name: "loose",
                ...
                this.takeAudio = new x(s), this.takeAudio.setBuffer(i), this.takeAudio.setLoop(!1), this.takeAudio.setRefDistance(200), this.takeAudio.setVolume(2), this.musics.push({
                    name: "take",
                ...
                this.readyJumpAudio = new x(s), this.readyJumpAudio.setBuffer(i), this.readyJumpAudio.setLoop(!1), this.readyJumpAudio.setRefDistance(10), this.readyJumpAudio.setVolume(2), this.readyJumpAudio.setPlaybackRate(2);
            }).catch((i)=>{
                console.error("Ошибка при загрузке аудио:", i);
            }), await a.loadAsync("audio/quack1.mp3").then((i)=>{
                this.jumpAudio = new x(s), this.jumpAudio.setBuffer(i), this.jumpAudio.setLoop(!1), this.jumpAudio.setRefDistance(400), this.jumpAudio.setVolume(.3), this.quacks.push(this.jumpAudio);
            }).catch((i)=>{
                console.error("Ошибка при загрузке аудио:", i);
            }), await a.loadAsync("audio/quack2.mp3").then((i)=>{
                this.jumpAudio2 = new x(s), this.jumpAudio2.setBuffer(i), this.jumpAudio2.setLoop(!1), this.jumpAudio2.setRefDistance(400), this.jumpAudio2.setVolume(.3), this.quacks.push(this.jumpAudio2);
            }).catch((i)=>{
                console.error("Ошибка при загрузке аудио:", i);
            }), await a.loadAsync("audio/quack3.mp3").then((i)=>{
                this.jumpAudio3 = new x(s), this.jumpAudio3.setBuffer(i), this.jumpAudio3.setLoop(!1), this.jumpAudio3.setRefDistance(400), this.jumpAudio3.setVolume(.3), this.quacks.push(this.jumpAudio3);
            }).catch((i)=>{
                console.error("Ошибка при загрузке аудио:", i);
            }), this.musics.push({
                name: "back",
        ...
        dayNight(s = !0, a = !1) {
            s && !this.musicDay ? this.timeToChange > 0 ? (this.timeToChange -= .01, this.musics.find((i)=>i.name === "back").music.setVolume(this.timeToChange)) : (this.timeToChange = 0, this.stopMusic([
                ...
                "back"
            ]), console.log(a), this.musics.find((i)=>i.name === "back").music = this.musics.find((i)=>a ? i.name === "back3" : i.name === "back2").music, this.playMusic([
                "back"
    ...
    class at {
        constructor(s, a, i, e, t){
            this.levelClass = s, this.isMobile = a, this.renderer = i, this.camera = e, this.paramsClass = t, this.mouse = new d, this.raycaster = new Ss;
        }
        addKeyListeners() {
        ...
        onKeyDown = (s)=>{
            switch(s.code){
                ...
                case "KeyD":
                case "ArrowRight":
                    this.levelClass.players.forEach((a, i, e)=>{
    ...
    class it {
        ...
        async loadWaterSky() {
            ...
            s.turbidity.value = 1, s.rayleigh.value = 3, s.mieCoefficient.value = 5e-4, s.mieDirectionalG.value = .8, this.parameters = {
                ...
                azimuth: 170,
                top: !1
            }, this.blackSky = new O(new os(1e4, 1e4), new gs({
                color: 526362,
                side: Ts,
                transparent: !0,
                opacity: 0
            ...
            const o = new Rs;
            o.setAttribute("position", new K(i, 3)), o.setAttribute("size", new K(e, 1)), o.setAttribute("color", new K(t, 3));
            const n = `
...
`;
        ...
        updateSky() {
            ...
            const i = z.degToRad(90 - this.parameters.elevation), e = z.degToRad(this.parameters.azimuth);
            if (this.sun.setFromSphericalCoords(1, i, e), this.sky.material.uniforms.sunPosition.value.copy(this.sun), this.water.material.uniforms.sunDirection.value.copy(this.sun).normalize(), this.paramsClass.gameDir == "hor" && (this.sun.y < -.07 && this.materialStars.uniforms.opacity.value < 1 ? (this.materialStars.uniforms.opacity.value += .001, this.blackSky.material.opacity < .8 && (this.blackSky.material.opacity += .001)) : this.sun.y > -.07 && this.materialStars.uniforms.opacity.value > 0 && (this.materialStars.uniforms.opacity.value -= .001, this.blackSky.material.opacity -= .001), this.parameters.elevation < -8 ? this.parameters.top = !0 : this.parameters.elevation > 6 && (this.parameters.top = !1), this.parameters.top ? (this.parameters.elevation += .003, this.dirLight.intensity += 3e-4, this.dirLight.intensity = Math.max(.5, Math.min(2, this.dirLight.intensity)), this.hemiLight.intensity += 3e-4, this.hemiLight.intensity = Math.max(.5, Math.min(2, this.hemiLight.intensity)), this.renderer.toneMappingExposure += 2e-4, this.renderer.toneMappingExposure = Math.max(.2, Math.min(1.05, this.renderer.toneMappingExposure))) : (this.parameters.elevation -= .003, this.dirLight.intensity -= 3e-4, this.dirLight.intensity = Math.max(.5, Math.min(2, this.dirLight.intensity)), this.hemiLight.intensity -= 3e-4, this.hemiLight.intensity = Math.max(.5, Math.min(2, this.hemiLight.intensity)), this.renderer.toneMappingExposure -= 3e-4, this.renderer.toneMappingExposure = Math.max(.2, Math.min(1.05, this.renderer.toneMappingExposure))), this.parameters.elevation < -2 ? this.night = !0 : this.night = !1), this.paramsClass.gameDir == "vert") {
        ...
        mainMenu = ()=>{
            document.querySelector(".new_game_btn1").addEventListener("click", ()=>{
                ...
                s.addEventListener("click", ()=>{
                    this.hideScreen("levels_game_screen"), this.initMatch(1, 2, a + 1, !0);
                });
    ...
    class rt {
        ...
        updateMetersFloat(s) {
            ...
            const a = cs, i = performance.now(), e = 200;
            function t(o) {
                const n = Math.min(1, (o - i) / e), r = 1 - Math.pow(1 - n, 4), h = Math.round(a + (s - a) * r);
    ...
    let cs = 0;
    console.clear();
    let es, ht = new ts, js, q, W, v, g, H, I, P, T;
    const U = new Is;
    U.background = new C(13230580);
    const y = new Us(25, window.innerWidth / window.innerHeight, .1, 2e3);
    y.position.z = 7;
    y.position.y = 2;
    const V = Ys();
    let X = new Ws;
    document.body.appendChild(X.dom);
    X.dom.style.top = "0px";
    X.dom.style.left = "48%";
    const j = new Ns;
    ...
    j.shadowMap.type = qs;
    j.outputColorSpace = Vs;
    j.toneMapping = Os;
    j.toneMappingExposure = 1.05;
    ws();
    window.addEventListener("resize", ws, !1);
    function ws() {
        V ? (y.aspect = document.body.offsetWidth / document.body.offsetHeight, y.updateProjectionMatrix(), j.setSize(innerWidth, innerHeight)) : (y.aspect = document.body.offsetWidth / document.body.offsetHeight, y.updateProjectionMatrix(), j.setSize(document.body.offsetWidth, document.body.offsetHeight));
    }
    async function dt(l) {
        ...
        es = new s.World(new s.Vector3(0, -9.81, 0)), js = new s.EventQueue(!0), v = new _(es, s), T = new rt(y), H = new et, W = new it(U, y, j, P, V), g = new tt(U, H, v, j, y, V, P, W);
        for(let a = 0; a < l; a++)g.players.push(new st(U, H, g, P, y));
        I = new at(g, V, j, y, P), I.addKeyListeners();
    }
    async function pt() {
        await W.loadWorld(), await H.loadAudio(), H.backAudio.play(), H.oceanAudio.play();
    }
    async function ut(l, s = s) {
        await g.createLevel(l, s = s), await g.loadEnvironments(), await g.loadPlayers(), g.objs.grassPlanes.data.length > 0 && g.objs.grassPlanes.data.forEach((a, i)=>{
            g.objs.grassPlanes.data[i].userData.collide.setCollisionGroups(J([
                0
            ], [
                1
            ]));
        }), g.players.length > 0 && g.players.forEach((a, i)=>{
            g.players[i].player.userData.collider.setCollisionGroups(J([
                1
            ], [
                0,
                1
    ...
    async function ct(l, s, a = !1, i = !0) {
        mt(), q.toggleLoader(!0), P = new nt, await dt(l), g.gameNum = s, await pt(), await ut(a, i = i), setTimeout(()=>{
            q.showScreen("hud"), q.toggleLoader(!1), P.dataLoaded = !0, P.gameStarting = !0;
        }, 300);
    }
    q = new ot(ct);
    function mt() {
        y.position.z = 7, y.position.y = 2, y.position.x = 0, j.toneMappingExposure = 1.05, I?.removedKeyListeners(), W = null, v = null, g = null, H = null, I = null, P = null, T = null;
    }
    function yt() {
        if (P.dataLoaded) {
            P.gameDir == "hor" ? T.updateMetersFloat(y.position.x - T.startX) : T.updateMetersFloat(y.position.y - T.startY), g.players.forEach((l, s, a)=>{
                l.playerMove();
            }), W.updateLighting(), g.levelAnimate(y), g.cameraMove(y), X.update();
            ...
            v.updateInstancedTransforms(), es.step(js), j.render(U, y);
        }
    }
    let $ = 0;
    const ms = 1 / 60, ys = .1;
