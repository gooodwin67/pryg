...
let __tla = (async ()=>{
    ...
    let nt = null;
    function z() {
        return (nt === null || nt.buffer.detached === !0 || nt.buffer.detached === void 0 && nt.buffer !== i.memory.buffer) && (nt = new DataView(i.memory.buffer)), nt;
    }
    function Qr(s) {
        s < 132 || (x[s] = lt, lt = s);
    }
    ...
    function ti() {
        ...
        try {
            ...
            i.version(a);
            var e = z().getInt32(a + 0, !0), r = z().getInt32(a + 4, !0);
    ...
    class K {
        ...
        intersectionWithShape(t, e, r, a, o, _, d, h, p, u, g) {
            try {
                ...
                var b = z().getInt32(C + 0, !0), m = z().getFloat64(C + 8, !0);
                return b === 0 ? void 0 : m;
            } finally{
    ...
    class E {
        ...
        coParent(t) {
            try {
                ...
                var e = z().getInt32(a + 0, !0), r = z().getFloat64(a + 8, !0);
                return e === 0 ? void 0 : r;
            } finally{
                i.__wbindgen_add_to_stack_pointer(16);
            }
        ...
        createCollider(t, e, r, a, o, _, d, h, p, u, g, b, m, C, H, W, B, O, Q, _t, Gt, Bt, Ot, Vt, ft) {
            try {
                ...
                var Ut = z().getInt32(Xt + 0, !0), Ne = z().getFloat64(Xt + 8, !0);
    ...
    function Li(s, t) {
        ...
        z().setFloat64(s + 8, y(r) ? 0 : r, !0), z().setInt32(s + 0, !y(r), !0);
    }
    function Ni(s) {
        return A(s);
    }
    ...
    q = class {
        constructor(t){
            this.enabled = !0, this.status = t, this.translation = w.zeros(), this.rotation = S.identity(), this.gravityScale = 1, this.linvel = w.zeros(), this.mass = 0, this.massOnly = !1, this.centerOfMass = w.zeros(), this.translationsEnabledX = !0, this.translationsEnabledY = !0, this.angvel = w.zeros(), this.principalAngularInertia = w.zeros(), this.angularInertiaLocalFrame = S.identity(), this.translationsEnabledZ = !0, this.rotationsEnabledX = !0, this.rotationsEnabledY = !0, this.rotationsEnabledZ = !0, this.linearDamping = 0, this.angularDamping = 0, this.canSleep = !0, this.sleeping = !1, this.ccdEnabled = !1, this.softCcdPrediction = 0, this.dominanceGroup = 0, this.additionalSolverIterations = 0;
        }
        static dynamic() {
        ...
        setAdditionalMassProperties(t, e, r, a) {
            return this.mass = t, w.copy(this.centerOfMass, e), w.copy(this.principalAngularInertia, r), S.copy(this.angularInertiaLocalFrame, a), this.massOnly = !1, this;
        }
    ...
    J = class {
        ...
        intoRaw() {
            let t = w.intoRaw(this.anchor1), e = w.intoRaw(this.anchor2), r, a, o = !1, _ = 0, d = 0;
            switch(this.jointType){
                ...
                case N.Rope:
                    ...
                    break;
                case N.Prismatic:
                    r = w.intoRaw(this.axis), this.limitsEnabled && (o = !0, _ = this.limits[0], d = this.limits[1]), a = L.prismatic(t, e, r, o, _, d), r.free();
                    break;
                case N.Generic:
    ...
    Fe = class extends k {
        constructor(t, e){
            super(), this.type = T.Polyline, this.vertices = t, this.indices = e ?? new Uint32Array(0);
        }
        intoRaw() {
    ...
    Or = class {
        constructor(t, e, r, a, o, _){
            this.params = e, this.bodies = o, this.colliders = _, this.broadPhase = r, this.narrowPhase = a, this.raw = new oi(t), this.rawCharacterCollision = new pr, this._applyImpulsesToDynamicBodies = !1, this._characterMass = null;
        }
        free() {
    ...
    F = class {
        constructor(t){
            this.enabled = !0, this.shape = t, this.massPropsMode = rt.Density, this.density = 1, this.friction = .5, this.restitution = 0, this.rotation = S.identity(), this.translation = w.zeros(), this.isSensor = !1, this.collisionGroups = 4294967295, this.solverGroups = 4294967295, this.frictionCombineRule = ht.Average, this.restitutionCombineRule = ht.Average, this.activeCollisionTypes = Et.DEFAULT, this.activeEvents = Pt.NONE, this.activeHooks = jt.NONE, this.mass = 0, this.centerOfMass = w.zeros(), this.contactForceEventThreshold = 0, this.contactSkin = 0, this.principalAngularInertia = w.zeros(), this.angularInertiaLocalFrame = S.identity();
        }
        static ball(t) {
            const e = new Ce(t);
            return new F(e);
...
export { Et as ActiveCollisionTypes, Pt as ActiveEvents, jt as ActiveHooks, Ce as Ball, kr as BroadPhase, zr as CCDSolver, Ae as Capsule, Br as CharacterCollision, ht as CoefficientCombineRule, ue as Collider, F as ColliderDesc, qr as ColliderSet, mt as ColliderShapeCastHit, De as Cone, It as ConvexPolyhedron, xe as Cuboid, ke as Cylinder, Wr as DebugRenderBuffers, Gr as DebugRenderPipeline, Ur as DynamicRayCastVehicleController, Yh as EventQueue, at as FeatureType, yr as FixedImpulseJoint, Pr as FixedMultibodyJoint, xr as GenericImpulseJoint, Lr as HalfSpace, ce as HeightFieldFlags, Me as Heightfield, X as ImpulseJoint, Ar as ImpulseJointSet, fr as IntegrationParameters, Mr as IslandManager, _e as JointAxesMask, J as JointData, N as JointType, Or as KinematicCharacterController, rt as MassPropsMode, oe as MotorModel, et as MultibodyJoint, Tr as MultibodyJointSet, Hr as NarrowPhase, Nr as PhysicsPipeline, de as PidAxesMask, Vr as PidController, ut as PointColliderProjection, bt as PointProjection, Fe as Polyline, Rr as PrismaticImpulseJoint, jr as PrismaticMultibodyJoint, ne as Quaternion, pe as QueryFilterFlags, Kh as Ray, Nt as RayColliderHit, pt as RayColliderIntersection, gt as RayIntersection, Cr as RevoluteImpulseJoint, Er as RevoluteMultibodyJoint, se as RigidBody, q as RigidBodyDesc, mr as RigidBodySet, V as RigidBodyType, Sr as RopeImpulseJoint, S as RotationOps, Le as RoundCone, At as RoundConvexPolyhedron, Ie as RoundCuboid, He as RoundCylinder, Ee as RoundTriangle, br as SdpMatrix3, ae as SdpMatrix3Ops, Pe as Segment, we as SerializationPipeline, k as Shape, ot as ShapeCastHit, st as ShapeContact, T as ShapeType, he as SolverFlags, Ir as SphericalImpulseJoint, Fr as SphericalMultibodyJoint, vr as SpringImpulseJoint, Xr as TempContactForceEvent, Dr as TempContactManifold, ze as TriMesh, le as TriMeshFlags, je as Triangle, ve as UnitImpulseJoint, Re as UnitMultibodyJoint, gr as Vector3, w as VectorOps, Te as Voxels, Wt as World, Qh as default, $h as reserveMemory, Zh as version, __tla };
