...
const messages = {
 ru: {
  ...
  hud: { metersLabel: "м", records: "Рекорды:", mine: "Мой:", world: "Мировой:" },
 ...
 en: {
  ...
  modes: {
   ...
   coop: { title: "Co-op", desc: "Beat levels together" },
  ...
  hud: { metersLabel: "m", records: "Records:", mine: "Mine:", world: "World:" },
